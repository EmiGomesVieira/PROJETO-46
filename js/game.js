class Game {
    ...
    play() {
        ...
        if (player.index !== null) {
            for (var i = 0; i < this.fruitGroup.length; i++) {
                if (this.fruitGroup.get(i).isTouching(players)) {
                    this.fruitGroup.get(i).destroy();
                    player.score = player.score + 1;
                    player.update();
                }
            }

            if (this.obstacleGroup.isTouching(players)) {
                gameState = 2;
            }
        }
    }
